...
import com.example.naver.web.filter.authentication.JwtAppleAuthenticationFilter;
...
public class SpringSecurityConfig {
    ...
    private String[] permitAllUrlPatterns() {
        return new String[] { "/", "/auth/kakao", "/auth/apple",
                "/auth/phone", "/auth/logout", "/auth/blacklist"};
    }
