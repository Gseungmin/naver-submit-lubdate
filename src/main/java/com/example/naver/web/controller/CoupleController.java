...
public class CoupleController {
    ...
    public List<MessageQueueRequestDto> getSynchronize(Authentication authentication, HttpServletRequest request) {
    ...
    public void ackSynchronize(@RequestBody AckRequestDto dto, Authentication authentication, HttpServletRequest request) {
        validateAuthentication(authentication, request);
        Long memberId = parseLong(authentication.getName());
