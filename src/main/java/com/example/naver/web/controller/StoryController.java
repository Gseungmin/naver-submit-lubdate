...
public class StoryController {
    ...
    /*스토리 목록 조회*/
    @GetMapping("/list")
    public StoryListItemResponseDto getStoryList(Authentication authentication, HttpServletRequest request,
                                                 @RequestParam(name = "lastUpdatedTime", required = false) LocalDateTime lastUpdatedTime,
                                                 @RequestParam(name = "coupleId") Long coupleId) {
    ...
    /*스토리 등록*/
    @PostMapping()
    public StoryItemResponseDto createStory(Authentication authentication, HttpServletRequest request,
    ...
    /*스토리 벌크 등록*/
    @PostMapping("/bulk")
    public StoryListItemResponseDto createBulkStory(Authentication authentication, HttpServletRequest request,
    ...
    /*스토리 업데이트*/
    @PatchMapping()
    public StoryItemResponseDto updateStory(Authentication authentication, HttpServletRequest request,
    ...
    /*스토리 삭제*/
    @DeleteMapping()
    public void deleteStory(Authentication authentication, HttpServletRequest request,
                                 @RequestBody StoryDeleteRequestDto dto) {
        validateAuthentication(authentication, request);
        validateStoryDeleteRequestDto(dto);
        Long memberId = parseLong(authentication.getName());
        storyService.deleteStory(dto.getStoryIds(), dto.getOtherId(), memberId, dto.getCoupleId());
    }
}
