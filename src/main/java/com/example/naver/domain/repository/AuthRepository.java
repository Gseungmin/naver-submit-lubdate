...
public interface AuthRepository extends JpaRepository<Auth, Long> {
    ...
    @Query("SELECT a FROM Auth a WHERE a.deleteDate IS NOT NULL AND a.deleteDate <= :thresholdDate AND a.isDelete = false")
    List<Auth> findAuthListForDelete(LocalDate thresholdDate);
}
