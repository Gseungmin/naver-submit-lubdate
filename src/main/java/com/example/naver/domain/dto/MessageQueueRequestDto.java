...
public class MessageQueueRequestDto {
    ...
    public MessageQueueRequestDto(StoryListItemResponseDto data, Long senderId, String status) {
    ...
    public MessageQueueRequestDto(StoryItemResponseDto data, Long senderId, String status) {
    ...
    public MessageQueueRequestDto(String messageId, StoryItemResponseDto data, Long senderId, String status) {
